<?php 
    ...
    // 35 * * * * /Applications/MAMP/bin/php/php7.4.33/bin/php /Applications/MAMP/auction/check_auction_end.php >> /Users/soran/Documents/php_scheduled_job.log 2>&1


    $time = date('Y-m-d H:i:s');
    echo "Scheduled job check_auction_end executed at " . $time . "\n";
    // 2023-11-22 21:08:00
